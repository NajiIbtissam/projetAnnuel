        ...
        <div class="inner-content">
            ...
            <div class="outter-wp">
                ...
                <div class="graph-visual tables-main">
                    <h2 class="inner-tittle">OUTPUT_RESULTS Table</h2>
                    <div class="graph">
                        <div class="tables">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach var="outputreults" items="${outputreults}">
                                    <tr>
                                        <th scope="row">${outputreults.ID}</th>
                                        <td>${outputreults.NAME}</td>
                                        <td>${outputreults.VALUE}</td>
                                        <td>${outputreults.ITEMCODE}</td>
                                    </tr>
                                </c:forEach>
