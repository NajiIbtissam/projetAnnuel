        ...
        <div class="inner-content">
            ...
            <div class="outter-wp">
                ...
                <div class="graph-visual tables-main">
                    <h2 class="inner-tittle">PLANNER_SETTINGS Table</h2>
                    <div class="graph">
                        <div class="tables">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach var="planner_setting" items="${planner_settings}">
                                    <tr>
                                        <th scope="row">${planner_setting.ID}</th>
                                        <td>${planner_setting.SETTINGS}</td>
                                        <td>${planner_setting.SETTING_VALUE}</td>
                                    </tr>
                                </c:forEach>
