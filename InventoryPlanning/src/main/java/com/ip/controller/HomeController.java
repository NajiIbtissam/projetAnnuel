...
public class HomeController {
    ...
    public
    @ResponseBody
    List<OUTPUT_MOVES> graphData(@RequestParam long day) {
        OUTPUT_MOVESDao omd = new OUTPUT_MOVESDaoImpl();
        return omd.getOutputMovesByDayfrom(day);
    }

    @RequestMapping(value = "getMovesDistinct", method = RequestMethod.GET)
    public
    @ResponseBody
    List<OUTPUT_MOVES> getOutputDistinctMovesByDayfrom(@RequestParam long day) {
        OUTPUT_MOVESDao omd = new OUTPUT_MOVESDaoImpl();
        return omd.getOutputDistinctMovesByDayfrom(day);
    }
    @RequestMapping(value = "getDaysNumber", method = RequestMethod.GET)
    public
    @ResponseBody
    String getDaysNumber() {
        OUTPUT_MOVESDao omd = new OUTPUT_MOVESDaoImpl();
