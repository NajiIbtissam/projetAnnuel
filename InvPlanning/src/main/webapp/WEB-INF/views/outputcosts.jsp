...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Output Costs</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="outputcost" items="${outputcosts}">
                            <tr>
                                <th scope="row">${outputcost.ID}</th>
                                <td>${outputcost.NAME}</td>
                                <td>${outputcost.WEIGHT}</td>
                                <td>${outputcost.RESULT}</td>
                                <td>${outputcost.ITEMCODE}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
