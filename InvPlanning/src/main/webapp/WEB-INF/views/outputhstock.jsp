...
<html>
<head>
    <title>Output Healthy Stock</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Output Healthy Stock</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="outputhstock" items="${outputhstock}">
                            <tr>
                                <th scope="row">${outputhstock.ID}</th>
                                <td>${outputhstock.LOCATIONCODE}</td>
                                <td>${outputhstock.ITEMCODE}</td>
                                <td>${outputhstock.DAY}</td>
                                <td>${outputhstock.QUANTITY}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
