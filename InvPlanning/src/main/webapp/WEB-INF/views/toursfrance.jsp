...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">ToursFrance</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="toursfrance" items="${toursfrance}">
                            <tr>
                                <th scope="row">${toursfrance.ID}</th>
                                <td>${toursfrance.LOCATION1CODE}</td>
                                <td>${toursfrance.LOCATION2CODE}</td>
                                <td>${toursfrance.DAYFROM}</td>
                                <td>${toursfrance.DAYTO}</td>
                                <td>${toursfrance.QUANTITY}</td>
                                <td>${toursfrance.TYPE}</td>
                                <td>${toursfrance.COST}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
