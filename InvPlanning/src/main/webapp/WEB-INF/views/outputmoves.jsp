...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Output Moves</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="outputmove" items="${outputmoves}">
                            <tr>
                                <th scope="row">${outputmove.ID}</th>
                                <td>${outputmove.ITEMCODE}</td>
                                <td>${outputmove.LOCATION1CODE}</td>
                                <td>${outputmove.LOCATION2CODE}</td>
                                <td>${outputmove.DAYFROM}</td>
                                <td>${outputmove.DAYTO}</td>
                                <td>${outputmove.QUANTITY}</td>
                                <td>${outputmove.TYPE}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
