...
<html>
<head>
    <title>Output Faulty Stock</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Output Faulty Stock</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="outputfstock" items="${outputfstock}">
                            <tr>
                                <th scope="row">${outputfstock.ID}</th>
                                <td>${outputfstock.LOCATIONCODE}</td>
                                <td>${outputfstock.ITEMCODE}</td>
                                <td>${outputfstock.DAY}</td>
                                <td>${outputfstock.QUANTITY}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
