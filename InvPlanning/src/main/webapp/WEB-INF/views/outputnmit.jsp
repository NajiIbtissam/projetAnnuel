...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Output Nmit</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="outputnmit" items="${outputnmit}">
                            <tr>
                                <th scope="row">${outputnmit.ID}</th>
                                <td>${outputnmit.LOCATIONCODE}</td>
                                <td>${outputnmit.ITEMCODE}</td>
                                <td>${outputnmit.DAY}</td>
                                <td>${outputnmit.QUANTITY}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
