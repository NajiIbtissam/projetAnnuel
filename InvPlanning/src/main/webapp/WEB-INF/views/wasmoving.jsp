...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Planner Settings</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12 col-md-6">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="datatable">
                        ...
                        <tbody>
                        <c:forEach var="wasmoving" items="${wasmoving}">
                            <tr>
                                <th scope="row">${wasmoving.ID}</th>
                                <td>${wasmoving.LOCATIONCODE}</td>
                                <td>${wasmoving.ITEMCODE}</td>
                                <td>${wasmoving.DAY}</td>
                                <td>${wasmoving.QUANTITY}</td>
                                <td>${wasmoving.TYPE}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
